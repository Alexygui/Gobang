...
function getNewestState() public view returns (bool, int8, int8, int8, int8) {
return (isBlackPlay, playerBlack.lastX, playerBlack.lastY, playerWhite.lastX, playerWhite.lastY);
}
